    ...
    <div id="courseSlider" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://bright.ktmracing.site/assets/images/Home/slider2.jpg" class="d-block w-100" alt="Slide 1"/>
            ...
            <div class="carousel-item">
                <img src="https://bright.ktmracing.site/assets/images/Home/slider1.jpg" class="d-block w-100" alt="Slide 2"/>
                <div class="carousel-caption d-none d-md-block">
                    <h5>Advanced Topics</h5>
                    <p>Learn about Cloud Computing, DevOps, and more.</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="https://bright.ktmracing.site/assets/images/Home/slider2.jpg" class="d-block w-100" alt="Slide 3"/>
                <div class="carousel-caption d-none d-md-block">
